...
export const About = () => {
  const aboutUs = [
    ...
    },
    {
      ...
      about:
        "I am Mohan Krishna Gupta. I am a person with a lot of enthusiasm to learn new things and I follow the motto “Live Life to the Fullest”. I mainly believe that hard work really matters in our progress. With my hard work I am in the top student in the college.I am pursuing final year B.Tech. in the department of Computers Science Engg., in MIT Moradabad. I am interested in Data Science and have made many projects which help me in improving my skills.",
    },
    {
      pic: Mohan,
      name: "Nirbhay Arora",
  ...
  const aboutMentors = [
    {
      ...
      about:
        "Aishwarya Gupta here,experienced programmer with several successful projects under my belt. I’d say my portfolio introduces me better than my words do, so if want we can look at it together, and I can tell you about the principal projects I engineered over the years. I’ve been working in one of the BIG 4 companies for 3 years, climbing the career ladder, learning the ins and outs of programming.Currently Working for another renowned IT company on the position of Senior...........",
    },
    {
      pic: Paras,
      about:
        "My name is MONIKA PANT.I'm an experienced software engineer who constantly seeks out innovative solutions to everyday problems. In my 5 years in this industry, I've honed my analytical thinking and collaboration skills, and I love working with a team. I've also had the opportunity to serve as the software engineer lead for three projects with First Technology.Currently wokring in an IT company as a lead.",
      name: "Monika Pant",
    },
